    ...
    Command {
        ...
        params: vec![
            ...
            opt(
                "insecure",
                PType::Bool,
                "Skip SHA-256 checksum verification of the download",
            ),
        ],
...
pub fn registry() -> Vec<Command> {
    ...
    c.push(
        cmd(
            ...
            "auth/logout",
            true,
            "Log out and clear the saved token",
            vec![],
        )
        .logout(),
    );
    ...
    c.push(cmd(
        "admin.home",
        "admin/workout/tool/home",
        true,
        "Admin dashboard summary (client counts etc.)",
        vec![],
    ));
    c.push(cmd(
        "admin.clients",
        ...
        vec![
            ...
            konst(
                ...
                PType::Bool,
                "false",
                "Include all clients regardless of scope",
            ),
        ],
    ));
    c.push(cmd(
        ...
        cmd(
            ...
            vec![
                konst(
                    ...
                    PType::Str,
                    "all",
                    "User type: client, workout, or all",
                ),
    ...
    c.push(cmd(
        ...
        vec![
            ...
            opt(
                "workout_month_type",
                PType::Str,
                "Workout month type / plan cadence",
            ),
            ...
            opt(
                "is_auto_generate",
                PType::Bool,
                "Auto-generate the workout plan",
            ),
            opt(
                "is_upload_app",
                PType::Bool,
                "Auto-upload the workout to app",
            ),
            opt(
                "is_send_email",
                PType::Bool,
                "Auto-send the workout via email",
            ),
            opt("phase", PType::Str, "Workout phase name (nullable)"),
            opt(
                "nutrition_phase",
                PType::Str,
                "Nutrition phase name (nullable)",
            ),
            opt(
                "phase_date",
                PType::Str,
                "Phase start date, format YYYY-MM-DD (nullable)",
            ),
            opt(
                "nutrition_activity_level",
                PType::Num,
            ...
            opt(
                "daily_crab",
                PType::Num,
                "Daily carbs target (legacy 'crab' key)",
            ),
    ...
    c.push(cmd(
        ...
        vec![
            req("uid", PType::Num, "Client user id"),
            req("coach_id", PType::Num, "Coach id"),
        ],
    ));
    c.push(cmd(
        "admin.coaches",
    ...
    let admin_meal = [
        (
            "admin.meal.list",
            "admin/nutrition/client/plan/list",
            "List a client's meal plans",
            vec![req("client_id", PType::Num, "Client id")],
        ),
        (
            "admin.meal.generate",
            "admin/nutrition/client/plan/generate",
            "Generate a meal plan for a month",
            vec![
                req("client_id", PType::Num, "Client id"),
                req("month", PType::Str, "Month (e.g. 2026-05)"),
            ],
        ),
        (
            "admin.meal.update",
            "admin/nutrition/client/plan/update",
            "Update meal plan content",
            vec![
                req("uuid", PType::Str, "Plan uuid"),
                req(
                    "content",
                    PType::Json,
                    "Plan content as a JSON array/object",
                ),
            ],
        ),
        (
            "admin.meal.update-targets",
            "admin/nutrition/client/plan/update-targets",
            "Update meal plan macro targets",
            vec![
                req("uuid", PType::Str, "Plan uuid"),
                req("targets", PType::Json, "Macro targets as a JSON object"),
            ],
        ),
        (
            "admin.meal.duplicate",
            "admin/nutrition/client/plan/duplicate",
            "Duplicate a meal plan to another month",
            vec![
                req("uuid", PType::Str, "Plan uuid"),
                req("month", PType::Str, "Target month"),
            ],
        ),
        (
            "admin.meal.delete",
            "admin/nutrition/client/plan/delete",
            "Delete a meal plan",
            vec![req("uuid", PType::Str, "Plan uuid")],
        ),
        (
            "admin.meal.preview",
            "admin/nutrition/client/plan/preview",
            "Preview a meal plan",
            vec![req("uuid", PType::Str, "Plan uuid")],
        ),
        (
            "admin.meal.publish",
            "admin/nutrition/client/plan/publish",
            "Publish a meal plan",
            vec![req("uuid", PType::Str, "Plan uuid")],
        ),
    ];
    ...
    c.push(cmd(
        "admin.food-split.list",
        "admin/nutrition/split/list",
        true,
        "List food splits",
        vec![],
    ));
    c.push(cmd(
        "admin.food-split.update",
        "admin/nutrition/split/update",
        true,
        &format!("Add/update a food split. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "admin.food-split.delete",
        "admin/nutrition/split/delete",
        true,
        &format!("Delete a food split. {PASS}"),
        vec![req("id", PType::Num, "Food split ID")],
    ));
    c.push(cmd(
        "admin.food-split.details",
        "admin/nutrition/split/details",
        true,
        "Get food split details",
        vec![req("food_split_id", PType::Num, "Food split id")],
    ));
    c.push(cmd(
        "admin.food-split.details-update",
        "admin/nutrition/split/details/update",
        true,
        &format!("Update/create a food split detail. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "admin.food-split.details-delete",
        "admin/nutrition/split/details/delete",
        true,
        &format!("Delete a food split detail. {PASS}"),
        vec![req("id", PType::Num, "Food split detail ID")],
    ));
    c.push(cmd(
        "admin.food-split.attach",
        "admin/nutrition/split/client/attach",
        true,
        &format!("Attach a client to a food split. {PASS}"),
        vec![
    ...
    c.push(cmd(
        ...
        "admin/nutrition/food/categories",
        true,
    ...
    c.push(cmd(
        "admin.food.create",
        "admin/nutrition/food/create",
        true,
        &format!("Create a food item. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "admin.food.update",
        "admin/nutrition/food/update",
        true,
        &format!("Update a food item. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "admin.food.delete",
        "admin/nutrition/food/delete",
        true,
        &format!("Delete a food item. {PASS}"),
        vec![req("id", PType::Num, "Food item ID")],
    ));

    // =========================================================== admin: nutrition levers
    c.push(cmd(
        "admin.lever.list",
        "admin/nutrition/lever/list",
        true,
        "List nutrition levers",
        vec![],
    ));
    c.push(cmd(
        "admin.lever.update",
        "admin/nutrition/lever/update",
        true,
        &format!("Add/update a nutrition lever. {PASS}"),
        vec![],
    ));
    ...
    c.push(cmd(
        "admin.video.options",
        "admin/video/workout/options",
        true,
        "Get video workout options",
        vec![],
    ));
    c.push(cmd(
        "admin.video.create",
        "admin/video/workout/create",
        true,
        &format!("Create a video workout entry. {PASS}"),
        vec![
            ...
            opt(
                "reps",
                PType::Str,
                "REP1-REP4 (REP1:6-10, REP2:8-12, REP3:10-15, REP4:15-20)",
            ),
        ],
    ));
    c.push(cmd(
        "admin.video.update",
        "admin/video/workout/update",
        true,
        &format!("Update a video workout entry. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "admin.workout.list",
        "admin/workout/client/plan/list",
        true,
        "List a client's workout plans",
        vec![req("client_id", PType::Num, "Client id")],
    ));
    c.push(cmd(
        "admin.workout.generate",
        "admin/workout/client/plan/generate",
        true,
        "Generate a workout plan for a month",
        vec![
            req("client_id", PType::Num, "Client id"),
            req("month", PType::Str, "Month"),
        ],
    ...
    c.push(cmd(
        "admin.workout.publish",
        "admin/workout/client/plan/publish",
        true,
        "Publish a workout plan",
        vec![req("uuid", PType::Str, "Plan uuid")],
    ));
    c.push(cmd(
        "admin.workout.notice",
        "admin/workout/client/plan/notice",
        true,
        "Send a workout plan notice (by uuid)",
        vec![req("uuid", PType::Str, "Plan uuid")],
    ));
    c.push(cmd(
        "admin.workout.notice-id",
        "admin/workout/notice",
        true,
        "Send a workout plan notice (by id)",
        vec![req("id", PType::Num, "Plan id")],
    ));
    c.push(cmd(
        "admin.workout.videos",
        "admin/workout/client/plan/videos",
        true,
        "List videos for a workout part",
        vec![
            req("part_name", PType::Str, "Body part"),
            req("gender", PType::Str, "Gender"),
        ],
    ));
    c.push(cmd(
        "admin.workout.video-plan",
        "admin/workout/client/plan/video/plan",
        true,
        "Get exercise-selection plan for a video",
        vec![
            req("video_id", PType::Num, "Video id"),
            req("part_name", PType::Str, "Body part"),
            req("gender", PType::Str, "Gender"),
        ],
    ));
    c.push(cmd(
        ...
        "admin/workout/client/plan/update",
        true,
    ...
    c.push(cmd(
        "admin.workout.duplicate",
        "admin/workout/client/plan/duplicate",
        true,
        "Duplicate a workout plan to another month",
        vec![
            req("uuid", PType::Str, "Plan uuid"),
            req("month", PType::Str, "Target month"),
        ],
    ...
    c.push(cmd(
        ...
        "admin/workout/client/plan/delete",
        true,
    ...
    c.push(cmd(
        "admin.split.list",
        "staff/workout/split/list",
        true,
        "List all splits + config",
        vec![],
    ));
    c.push(cmd(
        "admin.split.update",
        "admin/workout/split/update",
        true,
        &format!("Add/update a split. {PASS}"),
        vec![
            opt("id", PType::Num, "Split ID (omit to create new)"),
            opt("name", PType::Str, "Split name"),
            ...
            opt(
                "description",
                PType::Str,
                "Split description (may be empty)",
            ),
    ...
    c.push(cmd(
        "admin.split.delete",
        "admin/workout/split/delete",
        true,
        &format!("Delete a split. {PASS}"),
        vec![req("id", PType::Num, "Split ID")],
    ));
    c.push(cmd(
        "admin.split.details",
        "admin/workout/split/details",
        true,
        "Get split details",
        vec![req("split_id", PType::Num, "Split id")],
    ));
    c.push(cmd(
        "admin.split.details-update",
        "admin/workout/split/details/update",
        true,
        &format!("Update/create a split detail. {PASS}"),
        vec![
            opt("id", PType::Num, "Detail ID (omit to create new)"),
            ...
            opt(
                "day_number",
                PType::Str,
                "Day identifier (e.g. Day 1, Every 2nd Day)",
            ),
            opt("day_name", PType::Str, "Day name/label"),
    ...
    c.push(cmd(
        "admin.split.details-delete",
        "admin/workout/split/details/delete",
        true,
        &format!("Delete a split detail. {PASS}"),
        vec![req("id", PType::Num, "Split detail ID")],
    ));
    c.push(cmd(
        "admin.split.report",
        "admin/workout/split/report",
        true,
        "Split report with video availability",
        vec![],
    ));
    c.push(cmd(
        "admin.split.details-attach",
        "admin/workout/split/details/client/attach",
        true,
        &format!("Attach a client to a split detail. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "admin.split.details-detach",
        "admin/workout/split/details/client/detach",
        true,
        &format!("Detach a client from a split detail. {PASS}"),
        vec![
            req("id", PType::Num, "Split detail ID"),
    ...
    c.push(cmd(
        "admin.split.attach",
        "admin/workout/split/client/attach",
        true,
        &format!("Attach a client to a split. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "admin.split.detach",
        "admin/workout/split/client/detach",
        true,
        &format!("Detach a client from a split. {PASS}"),
        vec![
            req("split_id", PType::Num, "Split ID"),
            req("client_id", PType::Num, "Client (member) user ID to detach"),
        ],
    ...
    // =========================================================== admin: nowledge
    c.push(cmd(
        "admin.nowledge.status",
        "admin/nowledge/status",
        true,
        "Nowledge service status/health",
        vec![],
    ));
    c.push(cmd(
        "admin.nowledge.documents",
        "admin/nowledge/documents/list",
        true,
        "List company documents/context nodes",
        vec![opt("uri", PType::Str, "Filter by uri")],
    ));
    c.push(cmd(
        "admin.nowledge.sources",
        "admin/nowledge/documents/sources",
        true,
        "Canonical source registry with revision metadata",
        vec![],
    ));
    c.push(cmd(
        "admin.nowledge.source",
        "admin/nowledge/documents/source",
        true,
        "Fetch a single source's active-revision content",
        vec![req("source_id", PType::Str, "Source id")],
    ));
    c.push(cmd(
        "admin.nowledge.revisions",
        "admin/nowledge/documents/revisions",
        true,
        "List revisions for a source",
        vec![req("source_id", PType::Str, "Source id")],
    ));
    c.push(cmd(
        "admin.nowledge.preflight",
        "admin/nowledge/documents/preflight",
        true,
        &format!("Duplicate/overlap check before saving. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "admin.nowledge.create",
        "admin/nowledge/documents/create",
        true,
        &format!("Create a document (preflight + revision). {PASS}"),
        vec![
    ...
    c.push(cmd(
        "admin.nowledge.update",
        "admin/nowledge/documents/update",
        true,
        &format!("Update a document (new revision). {PASS}"),
        vec![
    ...
    c.push(cmd(
        "admin.nowledge.reindex",
        "admin/nowledge/documents/reindex",
        true,
        "Re-fragment a document",
        vec![req("source_id", PType::Str, "Source id")],
    ));
    c.push(cmd(
        "admin.nowledge.delete",
        "admin/nowledge/documents/delete",
        true,
        "Delete a source document (cascades fragments/revisions)",
        vec![req("source_id", PType::Str, "Source id")],
    ));
    c.push(cmd(
        "admin.nowledge.search",
        "admin/nowledge/context/search",
        true,
        "Search context (RAG-style hits)",
        vec![
    ...
    c.push(cmd(
        "admin.nowledge.title",
        "admin/nowledge/title/generate",
        true,
        &format!("Generate an AI title from content. {PASS}"),
        vec![req("content", PType::Str, "Content")],
    ));
    c.push(cmd(
        "admin.nowledge.answer",
        "admin/nowledge/rag/answer",
        true,
        &format!("Get a RAG answer with citations. {PASS}"),
        vec![req("question", PType::Str, "Question")],
    ));
    c.push(cmd(
        "admin.nowledge.proxy",
        "admin/nowledge/proxy",
        true,
        &format!("Generic Nowledge proxy. {PASS}"),
        vec![
    ...
    c.push(cmd(
        ...
        "staff/plan/meals",
        true,
        "List a member's (uploaded) meal plans",
        vec![req("uid", PType::Num, "User id")],
    ));
    c.push(cmd(
        "plan.meals.update",
        "staff/plan/meals/update",
        true,
        &format!("Update an uploaded meal plan. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "plan.meals.notice",
        "staff/plan/meals/notice",
        true,
        "Send a meal plan notice email",
        vec![req("id", PType::Num, "Record id")],
    ));
    ...
    c.push(
        cmd(
            "coach.clients",
            "staff/workout/client/list",
            true,
            "List the coach's assigned clients (--search filters client-side)",
            vec![opt(
                "search",
                PType::Str,
                "Filter returned clients by name/email (client-side)",
            )],
        )
        .client_filter(),
    );
    c.push(cmd(
        "coach.client-update",
        "staff/workout/client/update",
        true,
        &format!("Update client info (partial). {PASS}"),
        vec![
            req("id", PType::Num, "client id"),
            ...
            opt(
                "is_auto_generate",
                PType::Bool,
                "auto-generate flag (boolean or 0/1)",
            ),
            opt(
                "is_upload_app",
                PType::Bool,
                "upload-to-app flag (boolean or 0/1)",
            ),
            opt(
                "is_send_email",
                PType::Bool,
                "send-email flag (boolean or 0/1)",
            ),
            konst(
                "weight",
                PType::Num,
                "0",
                "weight, multiply 10 from actual weight (kg), default 0",
            ),
            ...
            opt(
                "split_date",
                PType::Str,
                "format YYYY-MM-DD, current split working date",
            ),
            opt(
                "split_level_date",
                PType::Str,
                "format YYYY-MM-DD, current phase working date",
            ),
            ...
            opt(
                "phase_date",
                PType::Str,
                "format YYYY-MM-DD, current phase start date (set to now when phase changes)",
            ),
            ...
            konst(
                ...
                PType::Num,
                "0",
                "initial weight, multiply 10 from actual weight (kg), default 0",
            ),
            opt(
                "last_meal_date",
                PType::Str,
                "format YYYY-MM-DD, last meal date",
            ),
            opt(
                "last_generate_date",
                PType::Str,
                "format YYYY-MM-DD, last generate date",
            ),
    ...
    c.push(cmd(
        "coach.publish-date",
        "staff/workout/publish/update",
        true,
        "Update a client's publish date",
        vec![
    ...
    c.push(cmd(
        ...
        "staff/member/search",
        true,
        "Search a member by name/email",
        vec![req("name", PType::Str, "Name or email")],
    ));
    c.push(cmd(
        "coach.attach",
        "staff/member/attach",
        true,
        "Add a client to the coach",
        vec![req("uid", PType::Str, "User id")],
    ));
    c.push(cmd(
        "coach.detach",
        "staff/member/detach",
        true,
        "Remove a client from the coach",
        vec![req("uid", PType::Str, "User id")],
    ));
    c.push(cmd(
        "coach.create",
    ...
    c.push(cmd(
        "coach.profile-history",
        "staff/client/profile/history",
        true,
        "Get a client's profile property change history",
        vec![
            req("uid", PType::Num, "User id"),
            req("property", PType::Str, "Property name"),
        ],
    ));
    c.push(cmd(
        "coach.info",
    ...
    c.push(cmd(
        "coach.merge-user",
        "staff/workout/client/merge-user",
        true,
        "Merge a source user into a target user",
        vec![
            req("target_uid", PType::Num, "Target user id"),
            req("source_uid", PType::Num, "Source user id"),
        ],
    ));
    ...
    c.push(cmd(
        "coach.email.check",
        "staff/client/emails/check",
        true,
        "Check if an email exists / belongs to a user",
        vec![req("email", PType::Str, "Email")],
    ));
    c.push(cmd(
        "coach.email.list",
        "staff/client/emails",
        true,
        "List a member's secondary emails",
        vec![req("uid", PType::Num, "User id")],
    ));
    c.push(cmd(
        "coach.email.create",
        "staff/client/emails/create",
        true,
        "Add a member secondary email",
        vec![
            req("uid", PType::Num, "User id"),
            req("email", PType::Str, "Email"),
        ],
    ...
    c.push(cmd(
        "coach.email.set-primary",
        "staff/client/emails/set-primary",
        true,
        "Set a member's primary email",
        vec![
            req("uid", PType::Num, "User id"),
            req("email", PType::Str, "Email"),
        ],
    ...
    c.push(cmd(
        "coach.email.delete",
        "staff/client/emails/delete",
        true,
        "Delete a member secondary email",
        vec![
            req("uid", PType::Num, "User id"),
            req("email", PType::Str, "Email"),
        ],
    ...
    let coach_meal = [
        (
            "coach.meal.list",
            "staff/nutrition/client/plan/list",
            "List a client's meal plans",
            vec![req("client_id", PType::Num, "Client id")],
        ),
        (
            "coach.meal.generate",
            "staff/nutrition/client/plan/generate",
            "Generate a meal plan for a month",
            vec![
                req("client_id", PType::Num, "Client id"),
                req("month", PType::Str, "Month"),
        ...
        (
            "coach.meal.update",
            "staff/nutrition/client/plan/update",
            "Update meal plan content",
            vec![
                req("uuid", PType::Str, "Plan uuid"),
                req(
        ...
        (
            "coach.meal.duplicate",
            "staff/nutrition/client/plan/duplicate",
            "Duplicate a meal plan to another month",
            vec![
                req("uuid", PType::Str, "Plan uuid"),
                req("month", PType::Str, "Target month"),
        ...
        (
            "coach.meal.delete",
            "staff/nutrition/client/plan/delete",
            "Delete a meal plan",
            vec![req("uuid", PType::Str, "Plan uuid")],
        ),
        (
            "coach.meal.preview",
            "staff/nutrition/client/plan/preview",
            "Preview a meal plan",
            vec![req("uuid", PType::Str, "Plan uuid")],
        ),
        (
            "coach.meal.publish",
            "staff/nutrition/client/plan/publish",
            "Publish a meal plan",
            vec![req("uuid", PType::Str, "Plan uuid")],
        ),
    ];
    ...
    c.push(cmd(
        "coach.meal.create",
        "staff/nutrition/client/plan/create",
        true,
        "Create a new meal plan",
        vec![
            req("client_id", PType::Num, "Client id"),
    ...
    c.push(cmd(
        "coach.food-split.list",
        "staff/nutrition/split/list",
        true,
        "List food splits",
        vec![],
    ));
    c.push(cmd(
        "coach.food-split.attach",
        "staff/nutrition/split/client/attach",
        true,
        &format!("Attach a client to a food split. {PASS}"),
        vec![
    ...
    c.push(cmd(
        ...
        "staff/workout/split/list",
        true,
        "List splits available to coaches",
        vec![],
    ));
    c.push(cmd(
        "coach.split.details",
        "staff/workout/split/details",
        true,
        "Get split details",
        vec![req("split_id", PType::Num, "Split id")],
    ));
    c.push(cmd(
        "coach.split.attach",
        "staff/workout/split/client/attach",
        true,
        &format!("Attach a client to a split. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "coach.split.detach",
        "staff/workout/split/client/detach",
        true,
        &format!("Detach a client from a split. {PASS}"),
        vec![
    ...
    c.push(cmd(
        "coach.workout.notice-id",
        "staff/workout/notice",
        true,
        "Send a workout plan notice (by id)",
        vec![req("id", PType::Num, "Plan id")],
    ));
    c.push(cmd(
        "coach.workout.list",
        "staff/workout/client/plan/list",
        true,
        "List a client's workout plans",
        vec![req("client_id", PType::Num, "Client id")],
    ));
    c.push(cmd(
        "coach.workout.generate",
        "staff/workout/client/plan/generate",
        true,
        "Generate a workout plan for a month",
        vec![
            req("client_id", PType::Num, "Client id"),
    ...
    c.push(cmd(
        "coach.workout.publish",
        "staff/workout/client/plan/publish",
        true,
        "Publish a workout plan",
        vec![req("uuid", PType::Str, "Plan uuid")],
    ));
    c.push(cmd(
        "coach.workout.notice",
        "staff/workout/client/plan/notice",
        true,
        "Send a workout plan notice (by uuid)",
        vec![req("uuid", PType::Str, "Plan uuid")],
    ));
    c.push(cmd(
        "coach.workout.videos",
        "staff/workout/client/plan/videos",
        true,
        "List videos for a workout part",
        vec![
            req("part_name", PType::Str, "Body part"),
    ...
    c.push(cmd(
        "coach.workout.video-plan",
        "staff/workout/client/plan/video/plan",
        true,
        "Get exercise-selection plan for a video",
        vec![
            req("video_id", PType::Num, "Video id"),
    ...
    c.push(cmd(
        ...
        "staff/workout/client/plan/update",
        true,
        "Update workout plan content",
        vec![
            req("uuid", PType::Str, "Plan uuid"),
    ...
    c.push(cmd(
        ...
        "staff/workout/client/plan/duplicate",
        true,
        "Duplicate a workout plan to another month",
        vec![
            req("uuid", PType::Str, "Plan uuid"),
    ...
    c.push(cmd(
        "coach.workout.delete",
        "staff/workout/client/plan/delete",
        true,
        "Delete a workout plan",
        vec![req("uuid", PType::Str, "Plan uuid")],
    ));
    ...
    c.push(cmd(
        ...
        true,
        "Get a member's recent check-ins",
        vec![req("id", PType::Str, "User id")],
    ));
    c.push(cmd(
        "coach.checkin.note",
        "staff/member/checkin/note",
        true,
        "Set a note on a check-in",
        vec![
            req("id", PType::Str, "Check-in id"),
            req("note", PType::Str, "Note"),
        ],
    ));
    c.push(cmd(
        "coach.checkin.answer-update",
        "staff/member/checkin/answer/update",
        true,
        "Update a single check-in answer (re-processes metrics)",
        vec![
            req("id", PType::Num, "Check-in id"),
            req("question", PType::Str, "Question key"),
            req("answer", PType::Str, "New answer"),
        ],
    ));
    ...
    c.push(cmd(
        "coach.weight.info",
        "staff/client/weight/info",
        true,
        "Get a client's weight goal",
        vec![req("uid", PType::Num, "User id")],
    ));
    c.push(cmd(
        "coach.weight.update",
        "staff/client/weight/update",
        true,
        "Create/update a client's weight goal",
        vec![
            req("uid", PType::Num, "User id"),
    ...
    c.push(cmd(
        "coach.weight.log-update",
        "staff/client/weight/log/update",
        true,
        "Submit a weight log entry",
        vec![
            req("uid", PType::Num, "User id"),
    ...
    c.push(cmd(
        "coach.weight.log-list",
        "staff/client/weight/log/list",
        true,
        "List weight log entries in a date range",
        vec![
            req("uid", PType::Num, "User id"),
            opt("start_date", PType::Str, "Start date"),
            opt("end_date", PType::Str, "End date"),
    ...
    c.push(cmd(
        "coach.weight.log-delete",
        "staff/client/weight/log/delete",
        true,
        "Delete a weight log entry",
        vec![
            req("uid", PType::Num, "User id"),
            req("id", PType::Num, "Log id"),
        ],
    ));

    // =========================================================== coach: step
    c.push(cmd(
        "coach.step.log-update",
        "staff/client/step/log/update",
        true,
        "Create/update a step log entry",
        vec![
            req("uid", PType::Num, "User id"),
    ...
    c.push(cmd(
        "coach.step.log-list",
        "staff/client/step/log/list",
        true,
        "List step log entries in a date range",
        vec![
            req("uid", PType::Num, "User id"),
            opt("start_date", PType::Str, "Start date"),
            opt("end_date", PType::Str, "End date"),
    ...
    c.push(cmd(
        "coach.step.log-delete",
        "staff/client/step/log/delete",
        true,
    ...
    // =========================================================== coach: sleep
    c.push(cmd(
        "coach.sleep.log-update",
        "staff/client/sleep/log/update",
        true,
        "Create/update a sleep log entry",
        vec![
            req("uid", PType::Num, "User id"),
    ...
    c.push(cmd(
        "coach.sleep.log-list",
        "staff/client/sleep/log/list",
        true,
        "List sleep log entries in a date range",
        vec![
            req("uid", PType::Num, "User id"),
            opt("start_date", PType::Str, "Start date"),
            opt("end_date", PType::Str, "End date"),
    ...
    c.push(cmd(
        "coach.sleep.log-delete",
        "staff/client/sleep/log/delete",
        true,
    ...
    c.push(cmd(
        "coach.text.stress",
        "staff/client/text/log/stress",
        true,
        "List stress log entries in a date range",
        vec![
            req("uid", PType::Num, "User id"),
            opt("start_date", PType::Str, "Start date"),
            opt("end_date", PType::Str, "End date"),
    ...
    c.push(cmd(
        "coach.text.dietary",
        "staff/client/text/log/dietary",
        true,
        "List dietary log entries in a date range",
        vec![
            req("uid", PType::Num, "User id"),
            opt("start_date", PType::Str, "Start date"),
            opt("end_date", PType::Str, "End date"),
    ...
    c.push(cmd(
        "coach.text.energy",
        "staff/client/text/log/energy",
        true,
        "List energy log entries in a date range",
        vec![
            req("uid", PType::Num, "User id"),
            opt("start_date", PType::Str, "Start date"),
            opt("end_date", PType::Str, "End date"),
    ...
    c.push(cmd(
        "coach.text.update",
        "staff/client/text/log/update",
        true,
        "Create/update a text log entry",
        vec![
            req("uid", PType::Num, "User id"),
    ...
    c.push(cmd(
        ...
        "staff/invoice/list",
        true,
        "List a client's invoices (incl. family members)",
        vec![req("uid", PType::Num, "User id")],
    ));
    c.push(cmd(
        "coach.invoice.download",
        "staff/invoice/invoice",
        true,
        "Get an invoice PDF download URL",
        vec![req("id", PType::Num, "Invoice id")],
    ));
    c.push(cmd(
        "coach.invoice.dietitian",
        "staff/invoice/dietitian",
        true,
        "Get a dietitian receipt PDF download URL",
        vec![req("id", PType::Num, "Invoice id")],
    ));
...
mod tests {
        ...
        for c in &reg {
            for a in &c.aliases {
                assert!(
                    ...
                    "alias '{a}' collides with a command name"
                );
    ...
    fn user_example_commands_resolve() {
        ...
        for name in ["auth.login", "admin.members", "coach.clients"] {
            assert!(
                reg.iter().any(|c| c.matches(name)),
                "missing example command: {name}"
            );
        }
    }
    ...
    fn only_login_skips_auth_among_http_commands() {
        ...
        let login = reg
            .iter()
            .find(|c| c.special == Special::Login)
